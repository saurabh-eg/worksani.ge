            ...
            <CardContent className="p-6 sm:p-8 space-y-5">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="relative">
                  ...
                  />
                  <Button type="button" variant="ghost" size="icon" className="absolute right-2 top-2/3 -translate-y-1/2 h-7 w-7 text-gray-500 hover:text-green-600" onClick={() => setShowPassword(!showPassword)}>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="focus:ring-green-500 focus:border-green-500"
                  />
                  <Button type="button" variant="ghost" size="icon" className="absolute right-2 top-2/3 -translate-y-1/2 h-7 w-7 text-gray-500 hover:text-green-600" onClick={() => setShowConfirmPassword(!showConfirmPassword)}>
